        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              A social platform for developers to showcase their projects, connect with peers, 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/developers" className="text-gray-400 hover:text-white transition-colors">
                  Find Developers
                </Link>
              </li>
              <li>
